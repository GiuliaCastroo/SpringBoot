...
public class UsuarioControllerTest {
	...
	@Test
	@Order(1)                                 //indica o método a ser o primeiro executado
	@DisplayName("Cadastrar um Usuário")    //e configura uma mensagem que será exibida ao invés do nome do método.
	public void deveCriarUmUsuario() {
		...
		public void deveAtualizarUmUsuario() {
			...
			"Juliana Ramos", "juliana_adrews@email.com.br", "juliana123")));
